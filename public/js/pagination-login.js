    ...
    /*---Initialize DataTable------------------------------------------*/
      var table=  $('#usertable').DataTable( {
        ...
        columns: [
            ...
            {title : "Phone", data: "phone", 'orderable' : false, 'searchable' : true,'sClass':'tablePhone' },
            {title : "City", data: "city", 'orderable' : true, 'searchable' : true,'sClass':'tableCity' },
            {title : "Status", data: "status", 'orderable' : true, 'searchable' : true,'sClass':'tableStatus' },
            {title : "Role", data: "role", 'orderable' : true, 'searchable' : true,'sClass':'tableRole' },
            {title : "Active", data: "activated", 'orderable' : true, 'searchable' : true,"visible": false },
            {title : "Actions",data: null, 'orderable' : false, 'searchable' : true,'sClass':'tableAction'},
            ],
            "order": [[ 1, "asc" ]],

            ajax: {
              url: '/admin/userlistData',
              type: 'GET',
              "data": function ( d ) {
